...
export const Testimonial = [
  {
    ...
    comment:
      'Complian improves my quality work by large margins as a compliance officer.',
    avatar_url: Client1,
  ...
  },
  {
    id: 2,
    name: 'Jeffrey Reyes',
    designation: 'Compliance Specialist - Change Healthcare',
    comment:
      'The time saved for inspections was definitely worth the investment.',
    avatar_url: Client2,
